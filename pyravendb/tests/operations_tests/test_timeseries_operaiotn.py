...
class TestTimeSeriesOperations(TestBase):
    ...
    def add_timeseries(self):
        ...
        time_series_operation.append(datetime(2021, 7, 7), 73, tag="heart/rates")
        time_series_operation.append(datetime(2021, 7, 7) + timedelta(minutes=5), 78, tag="heart/rates")
